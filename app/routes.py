...
def show(name):
    ...
    return render_template('show.html', obj=obj, chart_data=formatters.format_chart_data([obj]),\
        last_confirmed=formatters.last_confirmed([obj]), last_deaths=formatters.last_deaths([obj]))
