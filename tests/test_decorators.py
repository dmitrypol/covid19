...
def test_location_last_confirmed():
    ...
    obj2.save()
    assert decorators.last_confirmed([obj1]) == '3'
    assert decorators.last_confirmed([obj2]) == '2'
    assert decorators.last_confirmed([obj1, obj2]) == '5'
...
def test_location_last_deaths():
    ...
    obj2.save()
    assert decorators.last_deaths([obj1]) == '2'
    assert decorators.last_deaths([obj2]) == '1'
    assert decorators.last_deaths([obj1, obj2]) == '3'
